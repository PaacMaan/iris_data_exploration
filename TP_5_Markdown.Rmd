...
L’objectif : réaliser une application d’exploration des données (data iris) en utilisant la méthode de partitionnement k-means, instauré dans une architecture client serveur de Shiny, et la prsenté sous forme d'un document Markdown
